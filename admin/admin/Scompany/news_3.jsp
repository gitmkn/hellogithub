		...
		<div class="col-lg-12">
			<div class="header">
				<h1 class="page-header">
					<i class="fa fa-user-secret"></i>&nbsp;校企合作管理<small>&nbsp;&nbsp;&nbsp;校企地方政策管理</small><a
						class="btn btn-success" href="<%=request.getContextPath()%>/admin/ueditor/bjk.jsp?cs=13&cs2=0&cs3=/admin/Scompany/news_3.jsp" style="float:right;">增加政策</a>
				</h1>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">
						当前位置：<a href="news_3">校企合作管理</a>&nbsp;>>>&nbsp;<a href="news_3.jsp">校企地方政策管理</a>
					</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table
							...
							<%
								String xy = "";
								String sql = "select * from dynamic where type=13 order by createtime desc";
