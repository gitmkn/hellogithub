...
<%
String name=(String)session.getAttribute("name")+"执行了增加组建联盟";
if(name==null)name="非法操作";
String sql="insert into member(name,type) values('"+MyTools.toChinese(jx.getName())+"','3')";  
...
<script>
 alert("success");
 window.document.location.href="untiy_intro.jsp";
</script>
