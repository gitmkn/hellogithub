...
<a href="#">组建联盟</a><span></span>
 ...
 <tbody> 
  <tr> 
   ...
   border-right: #cccccc 1px dashed">组建联盟</td>
  </tr> 
  <%!int zys=1;
int gs=10000;
int zgs=1;
...
if(ys<1)ys=1;
if(ys>zys)ys=zys;
String sql="select id,name from member where type=3 order by id desc";
...
%>
  <tr> 
   <td  class="table1" ><a href="unity_detail.jsp?cs=<%=id%>" style="margin-left: 10px;color: #393c3d;" ><%=bt%></a></td> 
   <%}else{%>
   <td  class="table1"><a href="unity_detail.jsp?cs=<%=id%>" style="margin-left: 10px;color: #393c3d;"><%=bt%></a></td> 
   <%
}
