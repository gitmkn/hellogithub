		...
		<div class="col-lg-12">
			<div class="header">
				<h1 class="page-header">
					<i class="fa fa-user-secret"></i>&nbsp;校地合作管理<small>&nbsp;&nbsp;&nbsp;校地成果管理</small><a
						class="btn btn-success" href="<%=request.getContextPath()%>/admin/ueditor/bjk.jsp?cs=6&cs2=0&cs3=/admin/Sland/news_2.jsp" style="float:right;">增加成果</a>
				</h1>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">
						当前位置：<a href="news_2.jsp">校地合作管理</a> &nbsp;>>>&nbsp; <a href="news_2.jsp">校地成果管理</a>
					</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table
							...
							<%
								String xy = "";
								String sql = "select * from dynamic where type=6 order by createtime desc";
