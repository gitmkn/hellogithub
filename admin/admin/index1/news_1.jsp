		...
		<div class="col-lg-12">
			<div class="header">
				<h1 class="page-header">
					<i class="fa fa-user-secret"></i>&nbsp;首页管理<small>&nbsp;&nbsp;&nbsp;新闻资讯管理</small><a
						class="btn btn-success" href="<%=request.getContextPath()%>/admin/ueditor/bjk.jsp?cs=1&cs2=0&cs3=/admin/index1/news_1.jsp" style="float:right;">增加新闻</a>
				</h1>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">
						当前位置：<a href="<%=request.getContextPath()%>/admin/index.jsp">首页管理</a>&nbsp;>>>&nbsp;<a href="news1.jsp">新闻资讯管理</a>
					</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table
							class="table table-bordered table-hover table-striped tablesorter  " style=" vertical-align: middle; ">
							<thead>
								<tr>
							...
							<%
								String xy = "";
								String sql = "select * from dynamic where type=1 order by createtime desc";
