		...
		<div class="col-lg-12">
			<div class="header">
				<h1 class="page-header">
					<i class="fa fa-user-secret"></i>&nbsp;首页管理<small>&nbsp;&nbsp;&nbsp;通知公告管理</small><a
						class="btn btn-success" href="<%=request.getContextPath()%>/admin/ueditor/bjk.jsp?cs=3&cs2=0&cs3=/admin/index1/news_3.jsp" style="float:right;">增加公告</a>
				</h1>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">
						当前位置：<a href="<%=request.getContextPath()%>/admin/index.jsp">首页管理</a>&nbsp;>>>&nbsp;<a href="news_3.jsp">通知公告管理</a>
					</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table
							...
							<%
								String xy = "";
								String sql = "select * from dynamic where type=3 order by createtime desc";
			...
			<h3 align=right>
				<a class="btn btn-default" href="news_3.jsp?cs=<%=ys - 1%>">
					<span class="icon-angle-left"></span>上一页</a> <a
					href="news_3.jsp?cs=<%=ys%>"> <%
 	out.print(ys);
 %> </a> <a class="btn btn-default"
					href="news_3.jsp?cs=<%=ys + 1%>"> 下一页 <span
