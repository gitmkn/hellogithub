...
<DL class="infolist1" id="ilist2">
  <DT>
  <DIV class="tname">校企新闻</DIV>
  <DIV class="tmore"><A href="rlist.jsp?cs=11&cs2=校企新闻">更多&gt;&gt;</A></DIV></DT>
...
<SCRIPT type="text/javascript">
  ...
  <DD>
 <%
String sql = "select title,replace(title,substring(title from 15),'...'), date(createtime),id from dynamic where type=11 and state=1 order by id desc";
...
<DL class="infolist1" id="ilist3">
  ...
  <DIV class="tmore"><A href="rlist.jsp?cs=12&cs2=校企成果">更多&gt;&gt;</A></DIV></DT>
  <DD>
<%
						String sql2 = "select title,replace(title,substring(title from 15),'...'),date(createtime),id from dynamic where type=12 and state=1 order by createtime desc";
...
<DL class="infolist1" id="ilist4">
  ...
  <DIV class="tmore"><A 
  href="list.jsp?cs=11&cs2=校企合作行业资讯&cs3=12&cs4=13">更多&gt;&gt;</A></DIV></DT>
  <DD id="ilist4dd"> 
    <UL><%
						String sql1 = "select title,replace(title,substring(title from 15),'...'),date(createtime),id from dynamic where state=1 and id in( select id from dynamic where type=11 or type=12 or type=13)  order by createtime desc";
...
<DL class="infolist1" id="ilist5">
  ...
  <DIV class="tmore"><A 
  href="rlist.jsp?cs=13&cs2=校企合作地方政策">更多&gt;&gt;</A></DIV></DT>
  <DD>
 	  
	<%
						String sql3 = "select title,replace(title,substring(title from 15),'...'),date(createtime),id from dynamic where type=13 and state=1 order by createtime desc";
