...
<DL class="infolist1" id="ilist2">
  <DT>
  <DIV class="tname">校校新闻</DIV>
  <DIV class="tmore"><A href="rlist.jsp?cs=8&cs2=校校新闻">更多&gt;&gt;</A></DIV></DT>
...
<SCRIPT type="text/javascript">
  ...
  <DD>
 <%
String sql = "select title,replace(title,substring(title from 15),'...'), date(createtime),id from dynamic where type=8 and state=1 order by id desc";
...
<DL class="infolist1" id="ilist3">
  ...
  <DIV class="tmore"><A href="rlist.jsp?cs=9&cs2=校校成果">更多&gt;&gt;</A></DIV></DT>
  <DD>
<%
						String sql2 = "select title,replace(title,substring(title from 15),'...'),date(createtime),id from dynamic where type=9 and state=1 order by createtime desc";
...
<DL class="infolist1" id="ilist4">
  ...
  <DIV class="tmore"><A 
  href="list.jsp?cs=8&cs2=校校合作行业资讯&cs3=9&cs4=10">更多&gt;&gt;</A></DIV></DT>
  
  <DD id="ilist4dd"> 
   <UL> <%
						String sql1 = "select title,replace(title,substring(title from 15),'...'),date(createtime),id from dynamic where state=1 and id in( select id from dynamic where type=8 or type=9 or type=10)  order by createtime desc";
...
<DL class="infolist1" id="ilist5">
  ...
  <DIV class="tmore"><A 
  href="rlist.jsp?cs=10&cs2=校校合作地方政策">更多&gt;&gt;</A></DIV></DT>
  <DD>
 	  
	<%
						String sql3 = "select title,replace(title,substring(title from 15),'...'),date(createtime),id from dynamic where type=10 and state=1 order by createtime desc";
