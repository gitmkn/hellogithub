...
$(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:8px;bottom:30px; z-index:100'></div>");
var KSS_btnList = "";
...
$(ksbs + " .KSS_btnBox #btnlistID li").css({ listStyle: "none", float: "left", width: 10, height: 10, borderWidth: 0, borderColor: settings.btn.btn_borderColor, borderStyle: "solid", background: settings.btn.btn_bgColor, textAlign: "center", cursor: "pointer", marginLeft: 6, fontSize: 0, fontFamily: settings.btn.btn_fontFamily, lineHeight: "8px", opacity: settings.btn.btn_bgAlpha, color: settings.btn.btn_fontColor });
